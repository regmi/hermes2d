from hermes2d._hermes2d cimport scalar, FuncReal, GeomReal, WeakForm, \
        ...
        c_atan, c_pi, c_sqrt, c_sqr, c_atan2, c_sin
...
cdef scalar linear_form(int n, double *wt, FuncReal **t, FuncReal *u, FuncReal *v, GeomReal
        *e, ExtDataReal *ext):
    return R * int_F_v(n, wt, rhs, v, e)
...
def set_forms(WeakForm dp):
    ...
    dp.thisptr.add_vector_form(0, 0, &linear_form, &_order_bf, H2D_SYM)
