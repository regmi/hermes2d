...
def test_example_line_singularity():
...
def test_example_smooth_anixo_x():
...
def test_example_smooth_anixo_y():
...
def test_example_smooth_iso():
    from hermes2d.examples.csmooth_iso import set_bc, set_forms
    from hermes2d.examples import get_square_quad_mesh_smooth_iso
...
def test_example_singular_perturbation():
